...
public final class GTFSGraphBuilderTest {
	...
	public static void setTimezone() {
		...
		DateTimeZone.setDefault(DateTimeZone.forID(CURRENT_TIMEZONE));
	...
	public final void addAgencyTwoSameIds() {
		...
		actualBuilder.addAgency("i", null, DateTimeZone.forOffsetHours(0), null, null);
		actualBuilder.addAgency("i", null, DateTimeZone.forOffsetHours(1), null, null);
	}
	...
	public final void addAgencyTwoNullIds() {
		final GTFSGraphBuilder actualBuilder = createDefaultBuilder();
		actualBuilder.addAgency(null, null, DateTimeZone.forOffsetHours(0), null, null);
		actualBuilder.addAgency(null, null, DateTimeZone.forOffsetHours(1), null, null);
	}
	...
	public final void addAgencyIdBeforeNullId() {
		final GTFSGraphBuilder actualBuilder = createDefaultBuilder();
		actualBuilder.addAgency("i0", null, DateTimeZone.forOffsetHours(0), null, null);
		actualBuilder.addAgency(null, null, DateTimeZone.forOffsetHours(1), null, null);
	}
	...
	public final void addAgencyNullIdBeforeId() {
		final GTFSGraphBuilder actualBuilder = createDefaultBuilder();
		actualBuilder.addAgency(null, null, DateTimeZone.forOffsetHours(0), null, null);
		actualBuilder.addAgency("i1", null, DateTimeZone.forOffsetHours(1), null, null);
	}
	...
	public final void addDateIntervalTwoSameIds() {
		final GTFSGraphBuilder actualBuilder = createDefaultBuilder();
		actualBuilder.addDateInterval("i", new LocalDate(2002, 1, 1), new LocalDate(2002, 12, 31),
				ImmutableList.of(true, true, true, true, true, true, true));
		actualBuilder.addDateInterval("i", new LocalDate(2003, 1, 1), new LocalDate(2003, 12, 31),
	...
	public final void addDateIntervalBadDates() {
		final GTFSGraphBuilder actualBuilder = createDefaultBuilder();
		actualBuilder.addDateInterval("i", new LocalDate(2002, 12, 31), new LocalDate(2002, 1, 1),
				ImmutableList.of(true, true, true, true, true, true, true));
	}
	...
	public final void addDateAfterNegative() {
		final GTFSGraphBuilder actualBuilder = createDefaultBuilder();
		actualBuilder.removeDate("i", new LocalDate(2002, 1, 1));
		actualBuilder.addDate("i", new LocalDate(2002, 1, 1));
	}
	...
	public final void addDeparturesBadStop() {
		...
		actualBuilder.addStop("s0", "c0", "n0", "de0", new GPSLocation(100 + INITIAL_NODE_ID + 0, 100 +
				INITIAL_NODE_ID + 0, 0, 0), "z0", WheelchairBoarding.AT_LEAST_SOME_VEHICLES);
		actualBuilder.addStop("s1", "c1", "n1", "de1", new GPSLocation(100 + INITIAL_NODE_ID + 1, 100 +
				INITIAL_NODE_ID + 1, 0, 0), "z1", WheelchairBoarding.NO_ACCESSIBILITY_INFORMATION);
		actualBuilder.addRoute("r0", null, ModeOfTransport.BUS, "", "", "");
		actualBuilder.addDateInterval("d0", new LocalDate(2002, 1, 1), new LocalDate(2002, 12, 31),
				ImmutableList.of(true, true, true, true, true, true, true));
		actualBuilder.addDate("d0", new LocalDate(2003, 7, 23));
		actualBuilder.removeDate("d0", new LocalDate(2002, 7, 23));
		actualBuilder.addDepartures("s00", "s1", "r0", "d0", "t0", "h0", new Period(1, 0, 0, 0), Period.hours(1),
				new Period(47, 59, 59, 999), true, 111., Period.seconds(11));
	}
	...
	public final void addDeparturesBadRoute() {
		...
		actualBuilder.addDate("d0", new LocalDate(2003, 7, 23));
		actualBuilder.removeDate("d0", new LocalDate(2002, 7, 23));
		actualBuilder.addDepartures("s0", "s1", "r1", "d0", "t0", "h0", new Period(1, 0, 0, 0), Period.hours(1),
				new Period(47, 59, 59, 999), true, 111., Period.seconds(11));
	}
	...
	public final void addDeparturesAmbiguousRoute() {
		final GTFSGraphBuilder actualBuilder = createDefaultBuilder();
		actualBuilder.addAgency("a0", null, DateTimeZone.forID(TEST_TIMEZONE), null, null);
		actualBuilder.addAgency("a1", null, DateTimeZone.forID(TEST_TIMEZONE), null, null);
		actualBuilder.addStop("s0", "c0", "n0", "d0",
				new GPSLocation(100 + INITIAL_NODE_ID + 0, 100 + INITIAL_NODE_ID + 0, 0, 0), "z0",
				WheelchairBoarding.AT_LEAST_SOME_VEHICLES);
		actualBuilder.addStop("s1", "c1", "n1", "d1",
		...
		actualBuilder.addDate("d0", new LocalDate(2003, 7, 23));
		actualBuilder.removeDate("d0", new LocalDate(2002, 7, 23));
		actualBuilder.addDepartures("s0", "s1", "r0", "d0", "t0", "h0", new Period(1, 0, 0, 0), Period.hours(1),
				new Period(47, 59, 59, 999), true, 111., Period.seconds(11));
	}
	...
	public final void addDeparturesBadDates() {
		...
		actualBuilder.addDate("d0", new LocalDate(2003, 7, 23));
		actualBuilder.removeDate("d0", new LocalDate(2002, 7, 23));
		actualBuilder.addDepartures("s0", "s1", "r0", "d1", "t0", "h0", new Period(1, 0, 0, 0), Period.hours(1),
				new Period(47, 59, 59, 999), true, 111., Period.seconds(11));
	}
	...
	public final void addDeparturesBadTimes() {
		...
		actualBuilder.addDate("d0", new LocalDate(2003, 7, 23));
		actualBuilder.removeDate("d0", new LocalDate(2002, 7, 23));
		actualBuilder.addDepartures("s0", "s1", "r0", "d0", "t0", "h0", new Period(47, 59, 59, 999), Period.hours(1),
				new Period(1, 0, 0, 0), true, 111., Period.seconds(11));
	}
	...
	public final void addDeparturesZeroPeriod() {
		...
		actualBuilder.addDate("d0", new LocalDate(2003, 7, 23));
		actualBuilder.removeDate("d0", new LocalDate(2002, 7, 23));
		actualBuilder.addDepartures("s0", "s1", "r0", "d0", "t0", "h0", new Period(1, 0, 0, 0), Period.ZERO,
				new Period(47, 59, 59, 999), true, 111., Period.seconds(11));
	}
	...
	public final void flushToGraphTwoDatesTwoTimesDepartures() {
		...
		actualBuilder.addStop("i1", "c1", "n1", "d1", new GPSLocation(11, 11, 0, 0), "z1",
				WheelchairBoarding.NO_ACCESSIBILITY_INFORMATION);
		actualBuilder.addRoute("r0", null, ModeOfTransport.BUS, "", "", "");
		actualBuilder.addDate("s0", new LocalDate(2002, 1, 1));
		actualBuilder.addDate("s0", new LocalDate(2002, 1, 6));
		actualBuilder.addDepartures("i0", "i1", "r0", "s0", "t0", "h0", new Period(12, 0, 0, 0), Period.hours(1),
				new Period(13, 0, 0, 0), true, 111., Period.seconds(11));
		actualBuilder.addDepartures("i0", "i1", "r0", "s0", "t1", "h0", new Period(14, 0, 0, 0), Period.hours(1),
				new Period(15, 0, 0, 0), true, 111., Period.seconds(11));
		final Graph<Node, TimeDependentEdge> actual = actualBuilder.flushToGraph();
	...
	public final void flushToGraphTwoDatesIntervalTwoTimesIntervalDepartures() {
		...
		actualBuilder.addStop("i1", "c1", "n1", "d1", new GPSLocation(11, 11, 0, 0), "z1",
				WheelchairBoarding.NO_ACCESSIBILITY_INFORMATION);
		actualBuilder.addRoute("r0", null, ModeOfTransport.BUS, "", "", "");
		actualBuilder.addDateInterval("s0", new LocalDate(2002, 1, 1), new LocalDate(2002, 1, 8),
				ImmutableList.of(false, true, false, false, false, false, true));
		actualBuilder.addDepartures("i0", "i1", "r0", "s0", "t0", "h0", new Period(12, 0, 0, 0), Period.hours(2),
				new Period(15, 0, 0, 0), true, 111., Period.seconds(11));
		final Graph<Node, TimeDependentEdge> actual = actualBuilder.flushToGraph();
	...
	public final void flushToGraphTwoDatesIntervalWithExceptionsTwoTimesIntervalDepartures() {
		...
		actualBuilder.addDate("s0", new LocalDate(2002, 1, 6));
		actualBuilder.removeDate("s0", new LocalDate(2002, 1, 3));
		actualBuilder.addDepartures("i0", "i1", "r0", "s0", "t0", "h0", new Period(12, 0, 0, 0), Period.hours(2),
				new Period(15, 0, 0, 0), true, 111., Period.seconds(11));
		final Graph<Node, TimeDependentEdge> actual = actualBuilder.flushToGraph();
	...
	public final void flushToGraphLongDeparture() {
		...
		actualBuilder.addDate("s0", new LocalDate(2002, 1, 1));
		actualBuilder.addDepartures("i0", "i1", "r0", "s0", "t0", "h0", new Period(12, 0, 0, 0), Period.hours(1),
				new Period(13, 0, 0, 0), true, 111., Period.hours(23));
	...
	public final void flushToGraphVaryingTravelTimes() {
		...
		actualBuilder.addDepartures("i0", "i1", "r0", "s0", "t0", "h0", new Period(12, 0, 0, 0), Period.hours(1),
				new Period(13, 0, 0, 0), true, 111., Period.hours(23));
		actualBuilder.addDepartures("i0", "i1", "r0", "s0", "t1", "h0", new Period(13, 0, 0, 0), Period.hours(1),
				new Period(14, 0, 0, 0), true, 111., Period.hours(24));

		final Graph<Node, TimeDependentEdge> actual = actualBuilder.flushToGraph();
		List<TimeDependentEdge> routeEdges = actual.getAllEdges().stream().filter(e -> e instanceof RouteEdge).collect(
				toList());
	...
	public final void flushToGraphDstDeparture() {
		...
		actualBuilder.addStop("i1", "c1", "n1", "d1", new GPSLocation(11, 11, 0, 0), "z1",
				WheelchairBoarding.NO_ACCESSIBILITY_INFORMATION);
		actualBuilder.addRoute("r0", null, ModeOfTransport.BUS, "", "", "");
		actualBuilder.addDate("s0", new LocalDate(2013, 3, 31));
		actualBuilder.addDepartures("i0", "i1", "r0", "s0", "t0", "h0", new Period(2, 15, 0, 0), Period.hours(1),
				new Period(3, 15, 0, 0), true, 111., Period.minutes(15));
		final Graph<Node, TimeDependentEdge> actual = actualBuilder.flushToGraph();
	...
	public final void flushToGraphEqualStartEndDeparture() {
		...
		actualBuilder.addDepartures("i0", "i1", "r0", "s0", "t0", "h0", new Period(2, 15, 0, 0), Period.hours(1),
				new Period(3, -45, 0, 0), true, 111., Period.minutes(15));
		final Graph<Node, TimeDependentEdge> actual = actualBuilder.flushToGraph();
