...
public class SimplifiedInternalEdgeBuilder {
    public static final Comparator<SimplifiedInternalEdgeBuilder> LENGTH_COMPARATOR = ((o1, o2) -> Double.compare(o1.length, o2.length));
    ...
    private InternalEdgeBuilder createEdge(List<Integer> nodes, int length, Map<EdgeId, InternalEdgeBuilder> removedEdges) {
