...
public interface GTFSDataHandler {
	 ...
	 * @param agencyPhone
	 */
	public abstract void addAgency(final String id, String agencyName, final ZoneId timeZone, String agencyUrl,
								   String agencyPhone);
	 ...
	 */
	public abstract void addRoute(final String id, final String agency, final ModeOfTransport mode,
								  final String routeShortName, final String routeLongName,
	...
	/**
	 * Add departures from a stop. Duration parameters are used instead of LocalTime because Duration is able to handle times
	 * greater than one day allowed in GTFS (e.g. 25:01:57)
	 *
	 * @param origin
